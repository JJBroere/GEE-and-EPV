...
load('Sim100N40P20u.Rda')#simulated data
...
for(jj in 95:nsim){
    for (i_grid in 1:n_grid){
      ...
      resultaat <-  CV.PEE_LI(data=Sim100N40P20u[[jj]])
    ...
    Optimal4020u[jj,] <- as.numeric(grid[LOW_MSE[1],])
    }
save(Optimal4020u, file="Optimal4010u.Rda")
