#########################################################################################################################################################
setwd("C:/Users/Joris/Google Drive/School/Methodology & Statistics/Master scriptie/Data archief/Estimations")
source("Estimators and CV 405.R")
load('Sim100N40P5u.Rda')
######
...
for(jj in 1:nsim){
    for (i_grid in 1:n_grid){
      ...
      resultaat <-  CV.PEE_LI(data=Sim100N40P5[[jj]])
...
save(Optimal4005, file="Optimal4005.Rda")
  ...
  for(jj in 1:nsim){
    ...
    AAAA <-  PEE_LI2(data=Sim100N40P5[[jj]],method='SCAD')
